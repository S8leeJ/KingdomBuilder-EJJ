...
public class Sector {
    ...
    public void createSector(){
        ...
        if(id == 5){
            int[][] temp = {{2, 2, 2, 5, 5, 7, 2, 5, 5, 5}
                            ,{2, 2, 2, 8, 5, 7, 2, 5, 5, 5}
                            ,{2, 3, 3, 2, 5, 5, 7, 2, 2, 5}
                            ,{3, 3, 4, 2, 5, 7, 3, 14, 5, 5}
                            ,{3, 3, 3, 4, 4, 7, 3, 3, 7, 7}
                            ,{6, 6, 4, 2, 2, 7, 7, 7, 1, 1}
                            ,{4, 4, 4, 6, 2, 3, 3, 3, 1, 1}
                            ,{4, 4, 8, 1, 6, 1, 3, 3, 4, 4}
        ...
        if(id == 6){
            int[][] temp = {{4, 4, 4, 1, 1, 7, 1, 1, 1, 1}
                            ,{6, 6, 4, 1, 1, 7, 1, 1, 1, 1}
                            ,{6, 6, 4, 6, 6, 7, 1, 1, 12, 3}
                            ,{6, 4, 6, 6, 7, 6, 1, 3, 3, 3}
                            ,{4, 4, 5, 5, 7, 6, 6, 4, 3, 3}
                            ,{4, 5, 5, 7, 4, 4, 4, 6, 3, 3}
                            ,{4, 12, 5, 5, 7, 3, 3, 3, 3, 3}
                            ,{2, 2, 5, 7, 2, 8, 2, 3, 2, 5}
                            ,{2, 2, 5, 5, 7, 2, 2, 2, 2, 5}
                            ,{2, 2, 5, 5, 7, 2, 2, 2, 5, 5}};
                            types = temp;
        ...
        if(id == 7){
            int[][] temp = {{3, 1, 1, 6, 6, 1, 1, 4, 4, 4}
                            ,{3, 3, 1, 1, 1, 6, 6, 4, 4, 4}
                            ,{3, 3, 3, 3, 3, 3, 3, 6, 6, 6}
                            ,{7, 7, 3, 8, 2, 2, 5, 5, 6, 6}
                            ,{3, 3, 7, 7, 2, 2, 2, 5, 5, 4}
                            ,{3, 4, 4, 7, 2, 5, 5, 4, 4, 4}
                            ,{1, 3, 16, 4, 7, 5, 5, 16, 4, 2}
                            ,{1, 1, 4, 7, 5, 5, 2, 2, 2 ,2}
                            ,{1, 1, 1, 7, 5, 5, 5, 2, 2, 2}
                            ,{1, 1, 7, 7, 5, 5, 5, 2, 2, 2}};
                            types = temp;
